...
const SeasonalPlantCareTips = () => {
  ...
  return (
    <section className="bg-green-50 dark:bg-gray-800  p-6 rounded-2xl shadow-md my-8 flex flex-col items-center text-center">
      ...
      <div className="space-y-6 max-w-xl">
        {tips.map((tip, index) => (
          <div key={index} className="flex flex-col items-center gap-2">
            ...
            <p className="text-gray-700 dark:text-gray-200">{tip.tip}</p>
          </div>
        ))}
      </div>
    </section>
