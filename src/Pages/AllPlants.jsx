...
function AllPlants() {
  ...
  return (
    <section className=" p-4 md:w-6xl mt-22 mx-auto sm:p-6 dark:bg-gray-800 bg-green-50 rounded-2xl shadow-md">
      <Helmet>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white rounded-xl shadow text-sm">
          <thead>
            <tr className="bg-green-100 dark:bg-gray-800 text-left text-green-700">
          ...
          <tbody>
            {sortedPlants.map((plant) => (
              <tr
                key={plant._id}
                className="border-t dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-green-50"
              >
                <td className="px-4 dark:text-gray-200 py-3 font-medium text-green-900 whitespace-nowrap">
                  {plant.plantName}
                </td>
                <td className="px-4 dark:text-gray-200 py-3 text-gray-700 whitespace-nowrap">
                  {plant.category}
                </td>
                <td className="px-4 dark:text-gray-200 py-3 text-gray-700 whitespace-nowrap">
                  {plant.wateringFrequency}
                </td>
                <td className="px-4 dark:text-gray-200 py-3 whitespace-nowrap">
